...
Initial discussion - https://github.com/moonwalker/external-dns/issues/44
...
* [Plan](https://github.com/moonwalker/external-dns/issues/13) - object responsible for the create of change lists in external-dns
